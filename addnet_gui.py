...
class addnet_gui ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		bHSizer1.Add( self.m_lblNetName, 0, wx.ALIGN_LEFT|wx.ALL, 5 )

		self.m_txtNetName = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		bHSizer1.Add( self.m_txtNetName, 0, wx.ALL|wx.EXPAND, 5 )
		...
		bHSizer3.Add( self.m_lblComponet, 0, wx.ALL, 5 )
		...
		bHSizer2.Add( self.m_btnOk, 0, wx.ALIGN_CENTER, 5 )

		self.m_btnCancel = wx.Button( self, wx.ID_ANY, u"&Cancel", wx.DefaultPosition, wx.DefaultSize, 0 )
		bHSizer2.Add( self.m_btnCancel, 0, wx.ALL, 5 )


		bMainSizer.Add( bHSizer2, 1, wx.ALIGN_CENTER_HORIZONTAL, 5 )
